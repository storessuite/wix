...
class WixAppService
{
     ...
     */
    public function redirectToDashboard(WixSite $wixSite): RedirectResponse
    {
     ...
     * @param string $state - State is generated by our app and supplied to Wix.
     * @return RedirectResponse
     */
    public function redirectToInstallationPage(string $token = null, string $state = null): RedirectResponse
    {
        $appId = Config::get('wix.app_id');
     ...
     * @return RedirectResponse
     */
    public function closeWindow(WixAccessToken $wixAccessToken): RedirectResponse
    {
